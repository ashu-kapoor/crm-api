...
module.exports.updateCase = (app, middlewares, validator = null) => {
  ...
  if (middlewares && lodash.isArray(middlewares)) {
    middlewares.forEach((middleware) => {
      if (lodash.isFunction(middleware)) {
        ...
        throw new Error("Middleware not function " + updateCaseRoute);
      }
    });
  }
  ...
  if (validator && lodash.isFunction(validator)) {
    ...
    throw new Error("Validator not function " + updateCaseRoute);
  }
  middleWaresList.push(updateCaseController);
  app.put("/crm/v1/contacts/:contactId/cases/:caseId", middleWaresList);
};
