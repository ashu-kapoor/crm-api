...
module.exports.deleteOpportunity = (app, middlewares, validator = null) => {
  ...
  if (middlewares && lodash.isArray(middlewares)) {
    middlewares.forEach((middleware) => {
      if (lodash.isFunction(middleware)) {
        ...
        throw new Error("Middleware not function " + deleteOpportunityRoute);
      }
    });
  }
  ...
  if (validator && lodash.isFunction(validator)) {
    ...
    throw new Error("Validator not function " + deleteOpportunityRoute);
  }
  middleWaresList.push(deleteOpportunityController);
  app.delete(
