...
module.exports.deleteProduct = (app, middlewares, validator = null) => {
  ...
  if (middlewares && lodash.isArray(middlewares)) {
    middlewares.forEach((middleware) => {
      if (lodash.isFunction(middleware)) {
        ...
        throw new Error("Middleware not function " + deleteProductRoute);
      }
    });
  }
  ...
  if (validator && lodash.isFunction(validator)) {
    ...
    throw new Error("Validator not function " + deleteProductRoute);
  }
  middleWaresList.push(deleteProductController);
  app.delete("/crm/v1/products/:productId", middleWaresList);
};
