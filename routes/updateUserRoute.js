...
module.exports.updateUser = (app, middlewares, validator = null) => {
  ...
  if (middlewares && lodash.isArray(middlewares)) {
    middlewares.forEach((middleware) => {
      if (lodash.isFunction(middleware)) {
        ...
        throw new Error("Middleware not function " + updateUserRoute);
      }
    });
  }
  ...
  if (validator && lodash.isFunction(validator)) {
    ...
    throw new Error("Validator not function " + updateUserRoute);
  }
  middleWaresList.push(updateUserController);
  app.put("/crm/v1/users/:userId", middleWaresList);
};
