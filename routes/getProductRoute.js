...
module.exports.getProduct = (app, middlewares, validator = null) => {
  ...
  if (middlewares && lodash.isArray(middlewares)) {
    middlewares.forEach((middleware) => {
      if (lodash.isFunction(middleware)) {
        ...
        throw new Error("Middleware not function " + getProductRoute);
      }
    });
  }
  ...
  if (validator && lodash.isFunction(validator)) {
    ...
    throw new Error("Validator not function " + getProductRoute);
  }
  middleWaresList.push(getProductController);
  app.get("/crm/v1/products/:productId", middleWaresList);
};
